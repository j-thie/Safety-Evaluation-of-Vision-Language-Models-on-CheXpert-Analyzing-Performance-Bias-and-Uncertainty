...
def main():
    ...
    model_dir = '/path/to/model/medgemma-4b-it'
            ...
            messages = [
                {
                    ...
                    "content": [
                        {"type": "image"},
                        {
                            "type": "text",
                            "text": (
                                f"Prompt: {PROMPT_NAME}\n\n" #change prompt from line 177-184
                                "This is a chest X-ray.\n\n"
                                "Determine whether the following finding is present.\n\n"
                                "Return only:\n"
                                "Final Answer: X\n\n"
                                "Where:\n"
                                "1 = Yes\n"
    ...
    # summary log of debug information 
    ...
    output_dir = '/path/to/result/file'
