...
# data extraction for json format
...
PROMPT_NAME = "prompt_e" # change this as necessary for the appropriate prompt option 
...
def main():
    ...
    with open(json_path, "r") as f:
        ...
        print("Found", len(imagenet_images), "ImageNet images")
            ...
            messages = [ 
                {
                    ...
                    "content": [
                        {"type": "image"},
                        {
                            "type": "text",
                            "text": (
                                "You are a precise radiology image classifier looking at pathology and projections.\n"
                                "You may think briefly, but your output must end with a single final answer:\n"
                                "Final Answer: X\n"
                                "Where X is:\n"
    ...
    output_path = os.path.join(output_dir, f"MG_irrelevant_3{PROMPT_NAME}.json")
