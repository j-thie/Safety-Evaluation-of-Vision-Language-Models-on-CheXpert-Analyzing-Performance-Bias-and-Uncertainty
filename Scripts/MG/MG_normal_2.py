...
PROMPT_NAME = "prompt_a" # change this as necessary for the appropriate prompt option 
...
def main():
    ...
    for idx, entry in enumerate(entries):
        ...
        # -----------------------------------
        # Loop over questions (model calls)
        # -----------------------------------
                    ...
                    "content": [
                        {"type": "image"},
                        {
                            ...
                            "text": (
                                ...
                                "0 = No  (finding absent)\n"
                                "2 = I do not have the information needed to answer this question. No matter what the finding is, put 2 as the answer\n\n"
    ...
    output_path = os.path.join(output_dir, f"MG_normal_2{PROMPT_NAME}.json")
